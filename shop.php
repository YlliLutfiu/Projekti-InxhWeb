        ...
        <section class="product-categories">
            <div class="categories-nav">
                ...
                <ul>
                    ...
                    <a href="#oral-care-name"><li>Oral Care</li></a>
                    <a href="#personal-care-name"><li>Personal Care</li></a>
                    <a href="#bundles-name"><li>Bundles</li></a>
                    <a href="#gift-sets-name"><li>Gift Sets</li></a>
                </ul>
            </div>
        </section>
